#include <NTPtimeESP.h> // DateTime lib
#include "DHT.h"        // Sensor lib

//#define RESET   // Uncomment to clear RTC memory
#define Show(name,value) Serial.print(name); Serial.println(value);
#define DHTPIN D2         // Sensor pin
#define DHTTYPE DHT11     // Sensor type

// Struct that will carry DateTime variables
/* struct strDateTime {
byte hour, minute, sec, day, dayofWeek, month;
int year;
boolean valid;
};
size = 8 bytes = 2 RTC buckets;
*/
